              ...
              <form className="" action="#" onSubmit={handlesubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="bg-gray-50 border mb-1 border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <button
                  type="submit"
                  className="w-full text-black font-Poppins bg-cyan-500 hover:bg-cyan-300 focus:ring-4 focus:outline-none focus:ring-primary-300 mt-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  Submit
                </button>
              </form>
